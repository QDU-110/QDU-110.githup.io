...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # parser.add_argument('--results_dir', type=str, default='./datasets/testPET', help='saves results here.')
        parser.add_argument('--phase', type=str, default='test', help='train, val, test, etc')
        parser.add_argument('--num_test', type=int, default=90, help='how many test images to run')
