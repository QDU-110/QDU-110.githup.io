...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='06_26', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--num_threads', default=8, type=int, help='# sthreads for loading data_functions')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        parser.add_argument('--use_dropout', action='store_true', help='use dropout for the generator')
        parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data_functions argumentation')

        # model parameters
        parser.add_argument('--num_Ds', type=int, default=2, help='number of Discrminators')
        parser.add_argument('--netD', type=str, default='basic_128', help='selects model to use for netD')
        parser.add_argument('--netD2', type=str, default='basic_128', help='selects model to use for netD2')
        ...
        # extra parameters
        parser.add_argument('--where_add', type=str, default='input', help='input|all|middle; where to add z in the network G')
    ...
    def gather_options(self):
        ...
        dataset_option_setter = data_functions.get_option_setter(dataset_name)
