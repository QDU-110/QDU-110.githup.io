...
class Pix2PixModel(BaseModel):
    """ This class implements the pix2pix model, for learning a mapping from input images to output images given paired data_functions.
    ...
    def set_input(self, input):
        ...
        Parameters:
            input (dict): include the data_functions itself and its metadata information.
