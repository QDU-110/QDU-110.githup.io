...
You need to implement the following functions:
    ...
    <set_input>: Unpack input data_functions and perform data_functions pre-processing.
...
class TemplateModel(BaseModel):
    ...
    def set_input(self, input):
        """Unpack input data_functions from the dataloader and perform necessary pre-processing steps.

        Parameters:
            input: a dictionary that contains the data_functions itself and its metadata information.
        """
        AtoB = self.opt.direction == 'AtoB'  # use <direction> to swap data_A and data_B
        self.data_A = input['A' if AtoB else 'B'].to(self.device)  # get image data_functions A
        self.data_B = input['B' if AtoB else 'A'].to(self.device)  # get image data_functions B
